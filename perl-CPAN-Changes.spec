...
Version  : 0.500002
Release  : 27
URL      : https://cpan.metacpan.org/authors/id/H/HA/HAARG/CPAN-Changes-0.500002.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/H/HA/HAARG/CPAN-Changes-0.500002.tar.gz
...
%prep
%setup -q -n CPAN-Changes-0.500002
cd %{_builddir}/CPAN-Changes-0.500002
pushd ..
cp -a CPAN-Changes-0.500002 buildavx2
popd
...
cp %{_builddir}/CPAN-Changes-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-CPAN-Changes/a08d370afe83ffdc1a50e279e5da38c68e4d64bd || :
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-CPAN-Changes/a08d370afe83ffdc1a50e279e5da38c68e4d64bd
